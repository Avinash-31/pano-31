...
var countdown = setInterval(function () {
    ...
    if (distance < 0) {
        ...
        countdownElement.querySelector(".dday").innerText = 0;
        countdownElement.querySelector(".dhour").innerText = 0;
        countdownElement.querySelector(".dmin").innerText = 0;
        countdownElement.querySelector(".dsec").innerText = 0;
    }
}, 1000);
